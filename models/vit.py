...
default_cfgs = {
    ...
    'vit_base_patch16_clip_224': _cfg(
        url='https://huggingface.co/timm/vit_base_patch16_clip_224.openai/resolve/main/open_clip_pytorch_model.bin'),
...
@register_model
def phikon_v2(pretrained=False, **kwargs):
    """
    Owkin/phikon-v2 Vision Transformer.
    ...
    """
    model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, **kwargs)
    model = _create_vision_transformer('phikon_v2', pretrained=pretrained, **model_kwargs)
    return model
