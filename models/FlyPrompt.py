...
default_cfgs['vit_base_patch16_224_flyprompt'] = _cfg(
...
@register_model
def vit_base_patch16_224_flyprompt(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer('vit_base_patch16_224_flyprompt', pretrained=pretrained, **model_kwargs)
    return model
