...
class FlyPromptLSH(_Trainer):
    def __init__(self, *args, **kwargs):
        super(FlyPromptLSH, self).__init__(*args, **kwargs)
    ...
    def online_train(self, data):
        ...
        logit, loss = self.model_forward(x, y, mymask=logit_mask)
    ...
    def online_after_task(self, cur_iter):
        ...
        if hasattr(self.model_without_ddp, 'get_lsh_stats'):
            ...
            print(f"Task {cur_iter} LSH Stats:")
